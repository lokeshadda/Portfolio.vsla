      ...
      <Container className="relative z-10">
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.95fr] lg:items-start">
          <div>
            ...
            <h1 className="font-display mt-6 max-w-3xl text-4xl font-bold leading-tight tracking-tight text-slate-50 sm:text-5xl lg:text-[3.25rem] lg:leading-[1.15]">
              Building trusted{" "}
              <span className="text-teal-300">data</span> solutions that drive
